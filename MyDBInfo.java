...
public class MyDBInfo {
	public static final String MYSQL_USERNAME = "ccs108csebas";
	public static final String MYSQL_PASSWORD = "VtHTVQxcknx6h3X4";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_csebas";
}
